...
func InitOptionMap() {
	...
	common.OptionMap["RetryPriorityCycle"] = strconv.FormatBool(common.RetryPriorityCycle)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RetryPriorityCycle":
		common.RetryPriorityCycle, _ = strconv.ParseBool(value)
